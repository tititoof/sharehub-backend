...
module V1
  module Organizations
    # Update an organization with the specified attributes.
    #
    ...
    #
    # Returns the updated Organization object if the record was saved successfully, or error if validation failed.
    class UpdateService < ApplicationCallable
      attr_reader :organization, :user, :properties

      def initialize(organization, user, properties)
